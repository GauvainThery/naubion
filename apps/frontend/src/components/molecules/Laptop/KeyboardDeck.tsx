const KeyboardDeck = () => {
  return (
    <div className="absolute inset-2 rounded-md">
      {/* Trackpad */}
      <div className="absolute bottom-4 rounded-sm left-1/2 transform -translate-x-1/2 w-24 h-16 bg-gradient-to-b from-gray-600 to-gray-700 shadow-inner" />
      ...
      <div className="absolute top-4 left-4 right-4 bottom-24 grid grid-cols-15 gap-[2px] p-1 rounded-sm bg-gray-700">
        ...
        {Array.from({ length: 60 }, (_, i) => {
          if (i === 50) {
            return (
              <div
                className="w-34 h-[21px] bg-gradient-to-b from-black to-gray-800 rounded-sm shadow-sm"
                style={{
                  aspectRatio: '1',
                  fontSize: '6px',
