    ...
    <div className="flex flex-col lg:flex-row items-start justify-between gap-4">
      <div>
        <div className="flex items-center gap-2">
          ...
          <Tooltip
            content="This date reflects when the analysis was cached. Results are reused from cache when available to improve performance and reduce environmental impact."
            position="top"
          >
            <InfoIcon
